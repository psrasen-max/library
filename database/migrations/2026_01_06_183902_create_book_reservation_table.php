...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('book_reservation', function (Blueprint $table) {
            $table->foreignIdFor(Book::class, 'book_id')->onDelete('cascade'); // Chave estrangeira para a tabela books
            $table->foreignIdFor(Reservation::class, 'reservation_id')->onDelete('cascade'); // Chave estrangeira para a tabela reservations
