        ...
        <main class="main-content">
            ...
            <div class="row row-cols-1 row-cols-md-3 row-cols-xl-5 g-2 mb-3">
                ...
                <div class="col">
                    <div class="card shadow-sm border-0 rounded-3">
                        <div class="card-body text-center py-2">
                            <span class="text-muted small fw-bold text-uppercase">Faltantes</span>
                ...
                <div class="col-12 col-lg-4">
                    <div class="card shadow-sm border-0 rounded-3">
                        <div class="card-header bg-white py-2">
                            <h6 class="m-0 fw-bold small text-uppercase text-secondary">Categorias</h6>
                        </div>
                        <div class="card-body">
                            <div style="position: relative; height: 180px; width: 100%;">
                            ...
                            <tbody class="small">
                                @for ($i = 1; $i <= 5; $i++)
                                    <tr>
                                        ...
                                        <td class="fw-bold">Dom Casmurro</td>
